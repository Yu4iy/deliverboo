...
export default {
    ...
    methods: {
        ...
        addDishToCart(dish, index) {
            ...
            //             (e) => e.restaurant_slug === dish.restaurant_slug
            //         )
            //     ) {
            //         alert(
            //             "Stai per ordinare da un altro ristorante. Sei sicuro di voler procedere?"
            //         );
            //     }
            // }

            let provaData = JSON.parse(localStorage.getItem("localData"));
